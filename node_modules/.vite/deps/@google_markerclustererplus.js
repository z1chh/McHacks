...
var ClusterIcon = class extends OverlayViewSafe {
  /**
  ...
  onAdd() {
    ...
    google.maps.event.addDomListener(this.div_, "click", (e) => {
      ...
      if (!cDraggingMapByCluster) {
        ...
        google.maps.event.trigger(mc, "clusterclick", this.cluster_);
...
var getOption = (options, prop, def) => {
...
var markerclustererplus_esm_default = MarkerClusterer;
export {
  markerclustererplus_esm_default as default
};
//# sourceMappingURL=@google_markerclustererplus.js.map
